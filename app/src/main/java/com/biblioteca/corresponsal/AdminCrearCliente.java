...
public class AdminCrearCliente extends Activity implements View.OnClickListener {
    ...
    public void devolver(View v){
        switch (v.getId()){
            case R.id.regresar_crear_cliente:
                Intent intent = new Intent(AdminCrearCliente.this, AdminFuncionalidades.class);
        ...
        switch (v.getId()){
            case R.id.btn_confirmar:
                ...
                if (!clientes.getNombre().isEmpty() && !clientes.getCedula().isEmpty() && !clientes.getSaldo().isEmpty()) {
                    Intent intent = new Intent(AdminCrearCliente.this, AdminIngresarPin.class);
            ...
            case R.id.btn_cancelar:
                Intent intent2 = new Intent(AdminCrearCliente.this, CrearClienteAdminCancelado.class);
