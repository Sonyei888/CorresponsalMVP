...
public class CorresConfirmarPin extends AppCompatActivity implements View.OnClickListener{
        ...
        switch (v.getId()){
            case R.id.btn_aceptar_confirmar:
                ...
                if(Objects.equals(confirmar, confirmarpin)){
                    Intent intent2 = new Intent(CorresConfirmarPin.this, CorresConfirmarDatosClientes.class);
                    intent2.putExtra("llave3", clientes);
                    intent2.putExtra("llave30", corresponsal);
                    startActivity(intent2);
                }else {
                    Toast.makeText(this, "pin incorrecto", Toast.LENGTH_SHORT).show();
                    Intent intent3 = new Intent(CorresConfirmarPin.this, CorresCrearCliente.class);
            ...
            case R.id.btn_cancelar_pin_confirmar:
                Intent intent2 = new Intent(CorresConfirmarPin.this, CorresFuncionalidades.class);
                startActivity(intent2);
                finish();
                break;
        }
