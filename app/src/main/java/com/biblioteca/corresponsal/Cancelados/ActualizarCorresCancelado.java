...
public class ActualizarCorresCancelado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipo.setText("Actualizacion cancelada");
        findViewById(R.id.btn_transaccion_cancelada).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(ActualizarCorresCancelado.this, CorresFuncionalidades.class);
