...
public class CrearClienteAdminCancelado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipo.setText("Creacion cancelada");
        findViewById(R.id.btn_transaccion_cancelada).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(CrearClienteAdminCancelado.this, AdminFuncionalidades.class);
