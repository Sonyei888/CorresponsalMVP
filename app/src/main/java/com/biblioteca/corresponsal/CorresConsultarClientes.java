...
public class CorresConsultarClientes extends AppCompatActivity implements ConsultarClientesView, View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btn_aceptar_consultar_cliente:
                Intent intent = new Intent(CorresConsultarClientes.this, CorresFuncionalidades.class);
