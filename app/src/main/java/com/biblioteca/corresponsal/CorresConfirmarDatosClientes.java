...
public class CorresConfirmarDatosClientes extends Activity implements TransaccionesView, CrearClienteView, View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btn_aceptar_confirmar_datos:
                transacciones.setTipo_transaccion("Creacion de cuenta");
                transacciones.setMonto_trasaccion("0");
                ...
                boolean correcto = presenter.insertarCLiente(clientes);
                if(correcto == true){
                    Toast.makeText(this, "Registrando...", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CorresConfirmarDatosClientes.this, CorresConsultarClientes.class);
                    ...
                    Intent intent = new Intent(CorresConfirmarDatosClientes.this, CorresFuncionalidades.class);
                    startActivity(intent);
                }
                break;
            case R.id.btn_cancelar_confirmar_datos:
                Intent intent2 = new Intent(CorresConfirmarDatosClientes.this, CrearClienteCancelaodo.class);
