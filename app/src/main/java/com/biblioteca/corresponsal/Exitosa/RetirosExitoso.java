...
public class RetirosExitoso extends AppCompatActivity {
    TextView tipo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipo.setText("Retiro exitoso");
        findViewById(R.id.btn_transaccion_exitosa).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(RetirosExitoso.this, CorresFuncionalidades.class);
