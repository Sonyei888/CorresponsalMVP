...
public class ActualizarCorresponsalExitoso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipo.setText("Actualizacion exitosa");
        findViewById(R.id.btn_transaccion_exitosa).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(ActualizarCorresponsalExitoso.this, AdminFuncionalidades.class);
